...
<head runat="server">
  ...
  <title>E-kart - eCommerce Website</title>
    ...
    <div class="header-main">
      ...
      <div class="container">
        ...
        <a href="#" class="header-logo">
          <img src="logo.png" alt="E-kartś logo" width="120" height="36">
        </a>
        ...
        <div class="header-user-actions">
          ...
          <button class="action-btn">
            <a href="loginUser/Login.aspx" target="_blank">User Login</a>
            </button>
          <button class="action-btn">
            
            <a href="Login/Login.aspx" target="_blank">Vendor Login</a>
          </button>
          ...
          <li class="menu-category">
            ...
            <div class="dropdown-panel">
              ...
              <ul class="dropdown-panel-list">
                ...
                <li class="panel-list-item">
                  <a href="#">
                    <img src="banner1.jpeg" alt="headphone collection" width="250"
                      height="119">
                  </a>
                </li>
      ...
      <div class="container">
        ...
        <div class="slider-container has-scrollbar">
          ...
          <div class="slider-item">
            ...
            <img src="banner1111.jpg" alt="women's latest fashion sale" class="banner-img">

            <div class="banner-content">

              <p class="banner-subtitle">Trending items</p>

              <h2 class="banner-title">Latest Fashion On Here</h2>

              <p class="banner-text">
                starting at INR <b>20</b>.00
              </p>
        ...
        <div class="category-item-container has-scrollbar">
          ...
          <div class="category-item">
            ...
            <div class="category-img-box">
              <img src="vendor.jpg" alt="vendor" width="30">
            </div>

            <div class="category-content-box">

              <div class="category-content-flex">
                <h3 class="category-item-title">Vendor a</h3>
          ...
          <div class="category-item">
            ...
            <div class="category-content-box">
              ...
              <div class="category-content-flex">
                <h3 class="category-item-title">Vendor b</h3>
          ...
          <div class="category-item">
            ...
            <div class="category-content-box">
              ...
              <div class="category-content-flex">
                <h3 class="category-item-title">Vendor c</h3>
          ...
          <div class="category-item">
            ...
            <div class="category-content-box">
              ...
              <div class="category-content-flex">
                <h3 class="category-item-title">Vendor d</h3>
            ...
            <ItemTemplate>
              ...
              <div class="showcase">
                ...
                <div class="showcase-banner"> 
                    <asp:Image ID="Image1" runat="server" ImageUrl='<%# Bind("photo") %>' class="product-img default"></asp:Image>
                ...
                <div class="showcase-content">
                  ...
                  <asp:Label ID="Label1" runat="server" Text='<%# Bind("catg") %>'></asp:Label></a>
                  ...
                  <div class="price-box">
                    <p class="price"><asp:Label ID="Label3" runat="server" Text='<%# Bind("dprice") %>'></asp:Label></p>
                    <del><p><asp:Label ID="Label4" runat="server" Text='<%# Bind("oprice") %>'></asp:Label></p></del>
                  </div>
        ...
        <div class="testimonials-box">
          ...
          <div class="testimonial">
            ...
            <div class="testimonial-card">
              ...
              <img src="id.png" alt="alan doe" class="testimonial-banner" width="80" height="80">

              <p class="testimonial-name">Tankcoders</p>

              <p class="testimonial-title">Developers</p>
          ...
          <div class="cta-container">
            ...
            <a href="#" class="cta-content">
              ...
              <p class="cta-text">Starting @ INR10</p>
            ...
            <div class="service-container">
              ...
              <a href="#" class="service-item">
                ...
                <div class="service-content">
                  ...
                  <p class="service-desc">For Order Over INR150</p>
              ...
              <a href="#" class="service-item">
                ...
                <div class="service-content">
                  ...
                  <p class="service-desc">City Order Only</p>
              ...
              <a href="#" class="service-item">
                ...
                <div class="service-content">
                  ...
                  <p class="service-desc"> Working Hours 24*7 </p>
              ...
              <a href="#" class="service-item">
                ...
                <div class="service-content">
                  ...
                  <p class="service-desc">For Order Over INR100</p>
